...
Qwerty is a small project I made when I was messing around with the new [PyCord](https://docs.pycord.dev/) library. It uses Django's ORM to provide easy persistent storage.
